...
export default function Dashboard() {
  ...
  return (
    <>
      <div className="p-1 mx-auto -mt-56 w-full max-w-6xl h-full -space-y-12">
          ...
          {doctores?.map((doctor: any) => (
            <div className="p-1" key={doctor.nombre}>
              <div className="grid grid-cols-[auto_250px_minmax(0,1fr)] gap-1 justify-center shadow-[0_0_5px] shadow-gray-400 p-2 rounded-xl">
                <Image width={50} height={50} src="/imageProfile/avatarGrid.webp" alt="" />
                ...
                <div className=" flex gap-3 justify-end items-center">
                  ...
                  <button className="text-white bg-mlt-600 hover:bg-mlt-800 hover:scale-105 duration-300  transition-colors focus:outline-none font-medium rounded-full text-sm text-center p-[10px]">
                    Reservar cita
                  </button>
                </div>
              </div>
