...
export default async function Dashboard() {
  ...
  return (
    <>
      <div className="items-center justify-center md:mx-auto mt-10 md:mt-0 space-y-10 md:w-full max-w-[440px] md:max-w-[1200px] md:mr-6 md:space-y-6 px-2 mb-4 md:mb-0">
